...
export default function FullTuningPage() {
  const itens = [
    { nome: "Full Tuning", valor: "R$ 350.000" },
    { nome: "Full Tuning + Blindagem de Lataria e Pneu", valor: "R$ 1.850.000" },
    { nome: "Blindagem de Pneu e Lataria", valor: "R$ 1.500.000" },
  ]
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="px-5 pb-5">
        ...
        >
          Pacotes completos de modificação e blindagem
        </motion.p>
