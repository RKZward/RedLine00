...
export default function HelicopteroPage() {
  const itens = [
    { nome: "Turbo", valor: "R$ 50.000" },
    { nome: "Cor Primária", valor: "R$ 10.000" },
    { nome: "Cor Secundária", valor: "R$ 10.000" },
    { nome: "Perolado", valor: "R$ 10.000" },
    { nome: "Vidro Insulfilm", valor: "R$ 10.000" },
    { nome: "Motor 1", valor: "R$ 20.000" },
    { nome: "Motor 2", valor: "R$ 40.000" },
    { nome: "Motor 3", valor: "R$ 60.000" },
    { nome: "Motor 4", valor: "R$ 120.000" },
    { nome: "Freios 1", valor: "R$ 20.000" },
    { nome: "Freios 2", valor: "R$ 40.000" },
    { nome: "Freios 3", valor: "R$ 60.000" },
    { nome: "Remap", valor: "R$ 900.000" },
  ]
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="px-5 pb-5">
        ...
        >
          Serviços especializados para aeronaves
        </motion.p>
